...
async function connectMetamask() {
    ...
    async function loadContract() {
        const contractAddress = "0x4b83f012c0eb75d6661a3d61b50e3d39aac0c6a1"; // Replace with your contract address
    const contractABI = [
        {
            "inputs": [
                {
    ...
    async function fetchResults() {
        try {
            ...
            const remainingTime = parseInt(await contract.methods.electionTimer().call());
